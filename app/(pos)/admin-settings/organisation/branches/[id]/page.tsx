...
const mockBranches = [
  {
    ...
    regionalManager: "manager1",
    branchDirector: "director1",
    isActive: true,
    stockTracking: true,
...
export default function EditBranchPage() {
  ...
  useEffect(() => {
    if (id) {
      ...
      if (foundBranch) {
        ...
        // Redirige vers la liste si la branche n'existe pas
  ...
  const handleHourChange = (day: string, field: string, value: string) => {
    setFormData((prev) => ({
      ...prev,
      hours: {
        ...prev.hours,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Branche mise à jour :", formData);
    alert("Branche mise à jour !");
    router.push(`/settings/organization/branches/${id}`);
  };
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              placeholder="Saisissez le nom de la branche"
              className="w-full"
            />
          </div>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={handleChange}
              required
              placeholder="Saisissez l'adresse de la branche"
              className="w-full"
            />
          </div>
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger>
              <SelectValue placeholder="Sélectionner le directeur de branche" />
            </SelectTrigger>
            <SelectContent>
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold mt-2">Modifier la branche</h1>
        <p className="text-sm text-muted-foreground">
          Gérer les détails et les paramètres de la branche
        </p>
      </div>
